                ...
                <div class="rankingcontanier">
                    ...
                    <div class="ranking_category">
                        <ul>
                         ...
                         <li><a href="/RankingcountUser" style="color:red">개인 활동점수순 랭킹</a></li>
                  ...
                  <div class="rankingtopdiv">
                    <c:forEach var="row" items="${RankingcountUser}" begin="0" end="0">
	                        <div class="rankingtop">
                                    ...
                                    <div class="teamlogofile">
                                        <div class="rank_teamlogo_image"><img alt="미등록" src="../resources/img/${row.IMG_File_name }"/></div>
                                    </div>
                    ...
                    <c:forEach var="row" items="${RankingcountUser}" begin="1" end="1">
                    ...
                    <c:forEach var="row" items="${RankingcountUser}" begin="2" end="2">
					...
					<div class="rankingdiv">
	                    <table>
	                       <thead>
							...
							<c:forEach var="row1" items="${RankingcountUser}" begin="3" end="9">
		                       <tbody>
		                           <td>${row1.rowNum} 위</td>
		                           <td>
		                           	<c:choose>
